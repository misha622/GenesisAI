...
class TestTrainer:
    ...
    def test_clf(self,t,df): r=t.train(df,"churn","binary_classification","xgboost"); assert r.metrics["accuracy"]>0
    def test_reg(self,t,df): r=t.train(df,"salary","regression","xgboost"); assert "r2" in r.metrics
